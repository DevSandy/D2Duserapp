...
import com.iscript.d2duserapp.Adapter.RecyclerAdapterrr;
import com.iscript.d2duserapp.Adapter.RecyclerAdapterrr;
import com.iscript.d2duserapp.ui.dashboard.DashboardFragment;
...
public class grocerylistactivity extends AppCompatActivity implements RecyclerAdapterrr.OnItemClickListener {
    private RecyclerView mRecyclerView;
    private RecyclerAdapterrr mAdapter;
...
//    String uid = currentUser.getUid().toString();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_grocerylistactivity);
       ...
       uid = i.getExtras().getString("uid");
        ...
        add_cart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(grocerylistactivity.this, Cart.class);
...
//        mProgressBar.setVisibility(View.VISIBLE);
        ...
        mAdapter = new RecyclerAdapterrr (grocerylistactivity.this, mTeachers);
        mRecyclerView.setAdapter(mAdapter);
//        mAdapter.setOnItemClickListener((RecyclerAdapterrr.OnItemClickListener) grocerylistactivity.this);
        mAdapter.setOnItemClickListener(grocerylistactivity.this);

        mStorage = FirebaseStorage.getInstance();
        mDatabaseRef = FirebaseDatabase.getInstance().getReference("Groceriesstore").child(childkey).child(catogery);
