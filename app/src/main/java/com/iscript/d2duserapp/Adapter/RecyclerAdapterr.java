...
public  class RecyclerAdapterr extends RecyclerView.Adapter<RecyclerAdapterr.RecyclerViewHolder>{
    private groceriesstore mContext;
    private List<Teacher> teachers;
    private OnItemClickListener mListener;

    public RecyclerAdapterr(groceriesstore context, List<Teacher> uploads) {
        mContext = context;
        teachers = uploads;
    }
