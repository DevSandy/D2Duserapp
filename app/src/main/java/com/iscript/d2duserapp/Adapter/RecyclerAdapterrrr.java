...
public  class RecyclerAdapterrrr extends RecyclerView.Adapter<RecyclerAdapterrrr.RecyclerViewHolder>{
    private fruitstore mContext;
    private List<Teacher> teachers;
    private fruitstore mListener;

    public RecyclerAdapterrrr(fruitstore context, List<Teacher> uploads) {
        mContext = context;
        teachers = uploads;
    }
    ...
    public RecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_model, parent, false);
...
//                .into(holder.teacherImageView);
    ...
    public void setOnItemClickListener(fruitstore listener) {
        mListener = listener;
    }
