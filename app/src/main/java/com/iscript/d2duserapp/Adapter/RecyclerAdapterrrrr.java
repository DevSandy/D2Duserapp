...
import com.iscript.d2duserapp.fruitstorecontent;
...
public  class RecyclerAdapterrrrr extends RecyclerView.Adapter<RecyclerAdapterrrrr.RecyclerViewHolder>{
    private fruitstorecontent mContext;
    private List<Teacher> teachers;
    private fruitstorecontent mListener;
    private ElegantNumberButton btn1;



    public RecyclerAdapterrrrr(fruitstorecontent context, List<Teacher> uploads) {
        mContext = context;
        teachers = uploads;
    }
...
//            });
    ...
    public void setOnItemClickListener(fruitstorecontent listener) {
        mListener = listener;
    }
